...
export const sprites = new Map<string, SpriteConfig>([
  ...
  ["town/brick", { tileCoords: {x: 5, y: 0}}],
  ["town/window-green", { tileCoords: {x: 6, y: 0}}],
  ["town/floor-wooden", { tileCoords: {x: 7, y: 0}}],
  ["forest/cabin-wooden-light-v", { tileCoords: {x: 8, y: 0}}],
  ["forest/cabin-wooden-dark-v", { tileCoords: {x: 9, y: 0}}],
  ["forest/cabin-wooden-light-h", { tileCoords: {x: 8, y: 1}}],
  ["forest/cabin-wooden-dark-h", { tileCoords: {x: 9, y: 1}}],
